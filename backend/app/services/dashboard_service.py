...
class DashboardService:
    ...
    def get_dashboard_data(self, user_id: int) -> Dict:
        ...
        builder.with_prediction(self.prediction_service, balance, recurring, transactions)
        
        prediction = self.prediction_service.predict_month_end(balance, recurring, transactions)
