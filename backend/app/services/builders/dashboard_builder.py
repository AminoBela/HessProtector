...
class DashboardDataBuilder:
    ...
    def with_monthly_data(self, transactions: List[Dict], recurring: List[Dict]) -> 'DashboardDataBuilder':
    ...
    def with_gamification(self, gamification_service, balance: float, goals: List[Dict]) -> 'DashboardDataBuilder':
    ...
    def with_prediction(
        ...
        prediction = prediction_service.predict_month_end(balance, recurring, transactions)
