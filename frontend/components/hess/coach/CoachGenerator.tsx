        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 h-[calc(100vh-180px)] items-center">
            <Card className={`border-0 ${cardGlass} flex flex-col justify-center p-12 h-full relative`}>
                ...
                <div className="space-y-8">
                    ...
                    <Button onClick={onGenerate} disabled={updating} className={`w-full h-16 text-xl bg-white text-black hover:bg-zinc-200 font-bold rounded-2xl shadow-xl transition-all ${isLight ? 'border border-zinc-200' : ''}`}>
