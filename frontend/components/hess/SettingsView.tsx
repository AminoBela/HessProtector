...
import { LegalModal, LEGAL_TEXT } from "./LegalModals"
...
export function SettingsView({ settingsForm, setSettingsForm, updateSettings, language, theme, token, logout }: SettingsViewProps) {
    ...
    const cardGlass = isLight
        ? "bg-white/80 backdrop-blur-xl border-emerald-900/10 shadow-2xl text-slate-800"
        : "bg-zinc-900/80 backdrop-blur-2xl border-white/10 shadow-2xl text-white";
    ...
    const outlineButtonStyle = isLight
