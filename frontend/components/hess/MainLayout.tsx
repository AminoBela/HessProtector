import { ShieldCheck, LayoutDashboard, Bot, CalendarDays, Utensils, Target, TrendingUp, Settings, Trophy, Crown, Moon, Sun, Globe, Plus, Medal, ChartPie, LogOut, User } from "lucide-react"
    ...
    return (
        <div className={`flex h-screen font-sans overflow-hidden selection:bg-emerald-500/30 ${textColor}`}>
            ...
            <main className="flex-1 overflow-y-auto relative z-10 scrollbar-hide">
                <div className={`flex justify-between items-center sticky top-0 z-50 px-4 md:px-10 py-6 border-b transition-all duration-300 ${isLight ? 'bg-white/80 border-emerald-900/5 backdrop-blur-xl' : 'bg-black/60 border-white/5 backdrop-blur-xl'}`}>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <Dialog open={openTx} onOpenChange={setOpenTx}>
                            ...
                            <DialogContent className="bg-zinc-950/90 backdrop-blur-3xl border-white/10 text-white rounded-3xl p-8">
                                <DialogHeader>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <Button onClick={handleAddTx} className="w-full h-14 bg-white text-black hover:bg-zinc-200 font-black rounded-xl text-lg shadow-xl mt-2">{t.dialog.add}</Button>
                                </div>
                            </DialogContent>
                        </Dialog>
                    </div>
